...
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://localhost:8080/sso/register',
    desc: '用户注册逻辑',
});
api[0].list.push({
    alias: 'OpenApiControllerWebFlux',
    order: '2',
    link: '',
    desc: '',
    list: []
...
api[0].list[1].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:8080/OPEN_API_SPECIFICATION_PATH/',
    desc: '',
});
api[0].list.push({
    alias: 'OpenApiControllerWebMvc',
    order: '3',
    link: '',
    desc: '',
    list: []
