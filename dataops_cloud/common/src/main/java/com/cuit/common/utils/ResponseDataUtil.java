...
public class ResponseDataUtil {
    ...
    public static <T> ResponseData buildSuccess(T data, Integer total) {
        return new ResponseData<T>(ResultEnums.SUCCESS.getMsg(), data, total);
    }

    public static <T> ResponseData buildSuccess(String msg, T data) {
        return new ResponseData<T>(ResultEnums.SUCCESS.getCode(), msg, data);
    }
...
//    }
    ...
    public static ResponseData buildError(ResponseData responseData) {
        return responseData;
    }
